...
begin
	...
	if (@Quyen = 'Adminx')
	begin
	exec sp_addrolemember 'Adminx', @Username
	exec sp_addsrvrolemember 'Adminx', @Username
	end
...
update Hospital.HoaDons set GiaHD=50001 where MaHD=N'HD01'
...
delete Hospital.RedoTable
go
--exec Hospital.spCreatePhongs @MaPhong = N'P06', @MaLoaiPhong = N'LP01', @TenPhong = N'Phòng F', @Hide = 1
go
...
delete Hospital.RedoTable
go
--exec Hospital.spUpdatePhongs N'LP01',N'Phòng K',6
go
...
delete Hospital.RedoTable
go
--exec Hospital.spDeletePhongs N'P06'
go
...
drop proc Hospital.spRedoPhongs
go
...
--exec Hospital.spRedoPhongs
--select * from Hospital.Phongs
--select * from Hospital.UndoTable
--select * from Hospital.RedoTable
--go

--exec Hospital.spUndoPhongs
--select * from Hospital.Phongs
--select * from Hospital.UndoTable
--select * from Hospital.RedoTable
--go
--exec Hospital.spCreatePhongs N'P07',N'LP01',N'Phòng G',1;
--exec Hospital.spDeletePhongs N'P07';	
...
drop proc if exists Hospital.spRedoPhongs;
...
exec Hospital.SearchBenhNhan @HoBN=N'Đoàn Quốc';
go


create or alter proc Hospital.SearchBenhNhan
	@MaBN as nvarchar(10) = null,
	@HoBN as nvarchar(50) = null,
	@TenBN as nvarchar(50) = null,
	@NgaySinh as datetime = null,
...
exec Hospital.spCreateHD @MaHD=N'HD02',@TenHD=N'Hóa đơn B',@GiaHD=2,@Hide=0,@MaNV=N'NV02',@MaBA=N'BA04',@NgayLapHD='2019-12-09',@NgayThanhToanHD='2019-01-15';
...
go
CREATE or alter FUNCTION HienThiThu(@ngay DATETIME) 
RETURNS NVARCHAR(10)
AS
BEGIN 
	DECLARE @st NVARCHAR(10)          
...
go
 ...
 delete from Hospital.BacSis where MaBS=N'BS05'

 select * from Hospital.BacSis;
>>>>>>> 2d0245bfb62d244b13cdcd5224acca7831143cfd
